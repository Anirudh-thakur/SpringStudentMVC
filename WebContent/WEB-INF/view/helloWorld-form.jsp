...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <form class="form-inline" action="processFormVersiontwo" method="GET">
    <input class="form-control mr-sm-2" type="search" name="name" placeholder="What's your name?" aria-label="Search">
